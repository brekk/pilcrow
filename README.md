...
This file is automatically created from [this source](https://github.com/brekk/pilcrow/blob/main/README.raw.md?plain=1), which makes use of a magic constant `$__$MADLIB__` in order to render correctly. Don't use that unless you need to explain the utility of this library. 
